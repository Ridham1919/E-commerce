...
// import banner from '../assets/women.png'
...
const Womens = () => {
  ...
  return (
    <div className='md:mt-33 mt-20 max-w-7xl mx-auto'>
      <div >
        <img src="https://clothify-two.vercel.app/assets/WomensBanner-CNgoJ09v.png" alt="" className='w-screen ' />
      </div>
