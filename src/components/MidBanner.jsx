  ...
  return (
     <div className='bg-gray-100 py-24'>
       <div className='relative  max-w-6xl mx-auto md:rounded-2xl pt-28 bg-cover bg-center h-[500px] '
        style={{backgroundImage:`url(https://assets.teenvogue.com/photos/64403f8809e18833cf1d7ab2/16:9/w_5999,h_3374,c_limit/1471768314)`,backgroundPosition:`120px `,backgroundAttachment:`fixed` }}>
