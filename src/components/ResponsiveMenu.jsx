...
const ResponsiveMenu = ({ showMenu, setShowMenu }) => {
  ...
  return (
    <div
      ref={menuRef}
      className={`${showMenu ? "left-0" : "-left-[100%]"} fixed bottom-0 top-0 z-20 flex h-screen w-[75%] flex-col justify-between bg-white px-8 pb-6 pt-16 text-black transition-all duration-200 md:hidden rounded-r-xl shadow-md`}
    >
      <div>
        ...
        <nav className="mt-12">
          ...
          <div className="absolute bottom-45 left-5">
            <h1>
              Made with ❤️ by <a href="https://github.com/Ridham1919" target='blank' className="font-bold pl-2 ">Ridham</a>
            </h1>
          </div>
